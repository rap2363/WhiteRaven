 ...
 *
 * There are three contiguous main.java.memory spaces in total:
...
public class ConsoleMemory extends MemoryMap {
    ...
    /**
     * Read a byte from the PPU main.java.memory space.
     *
     * @param address
     * @return
     */
    ...
    /**
     * Write a byte into the PPU main.java.memory space.
     *
     * @param address
     * @param value
     */
    ...
    /**
     * Return the VRAM address maintained by I/O register main.java.memory
     *
     * @return
     */
