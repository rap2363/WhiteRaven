...
public class CPURAM extends MemoryMap {
    ...
    /**
     * Read a byte from main.java.memory (implemented with main.java.memory mirrors)
     *
     * @param address
     * @return
     */
    ...
    /**
     * Write a byte into main.java.memory (implemented with main.java.memory mirrors)
     *
     * @param address
     * @param value
     */
