...
public class IORegisterMemory extends MemoryMap {
    ...
    private ConsoleMemory consoleMemory; // reference to console main.java.memory
    ...
    /**
     * Read a byte from main.java.memory (implemented with main.java.memory mirrors). The address provided is between 0x0 and 0x2020
     *
     * @param address
     * @return
     */
    ...
    /**
     * Write a byte into main.java.memory (this map references 0x2000 --> 0x4020) and address is between 0x0 and 0x2020
     *
     * @param address
     * @param value
     */
     ...
     * This writes the byte to $2007 in main main.java.memory as well as vramAddress in PPU main.java.memory.
     */
     ...
     * Reads the data from a buffer, which is updated directly from PPU main main.java.memory.
     */
