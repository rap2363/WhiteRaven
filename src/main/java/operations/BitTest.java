...
abstract class BitTestOperationBase extends Operation {
     ...
     * main.java.memory location. The mask pattern in A is ANDed with the value in main.java.memory
     * to set or clear the zero flag, but the result is not kept. Bits 7 and 6
     * of the value from main.java.memory are copied into the N and V flags.
     *
     * A&M,N = M7, V = M6
     */
    @Override
